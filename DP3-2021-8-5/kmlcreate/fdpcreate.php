...
$NetStyleNode->setAttribute('id', 'fdpst1');
...
$NetHref = $dom->createElement('href', 'http://ossportal/out_dated/SLTIlastrator/images/bluestar.png');
...
$NetStyleNode = $dom->createElement('Style');
$NetStyleNode->setAttribute('id', 'fdpst2');
$NetIconstyleNode = $dom->createElement('IconStyle');
$NetIconstyleNode->setAttribute('id', 'msan');
$Netscale=$dom->createElement('scale', '0.95');
$NetIconstyleNode->appendChild($Netscale);
$NetIconNode = $dom->createElement('Icon');
$NetHref = $dom->createElement('href', 'http://ossportal/out_dated/SLTIlastrator/images/yellowstar.png');
$NetIconNode->appendChild($NetHref);
$NetIconstyleNode->appendChild($NetIconNode);
$NetStyleNode->appendChild($NetIconstyleNode);
$docNode->appendChild($NetStyleNode);
...
$NetStyleNode = $dom->createElement('Style');
$NetStyleNode->setAttribute('id', 'fdpst3');
$NetIconstyleNode = $dom->createElement('IconStyle');
$NetIconstyleNode->setAttribute('id', 'msan');
$Netscale=$dom->createElement('scale', '0.95');
$NetIconstyleNode->appendChild($Netscale);
$NetIconNode = $dom->createElement('Icon');
$NetHref = $dom->createElement('href', 'http://ossportal/out_dated/SLTIlastrator/images/redstar.png');
$NetIconNode->appendChild($NetHref);
$NetIconstyleNode->appendChild($NetIconNode);
$NetStyleNode->appendChild($NetIconstyleNode);
$docNode->appendChild($NetStyleNode);
...
while ($row = oci_fetch_array($res)) {
  ...
  if ($freeloop > 3)
  {
    ...
    $styleUrl = $dom->createElement('styleUrl', '#fdpst1');
  ...
  if ($freeloop  < 4 && $freeloop  > 0)
  {
    ...
    $styleUrl = $dom->createElement('styleUrl', '#fdpst2');
    $placeNode->appendChild($styleUrl);
  ...
  if ($freeloop == 0)
  {
    ...
    $styleUrl = $dom->createElement('styleUrl', '#fdpst3');
    $placeNode->appendChild($styleUrl);
