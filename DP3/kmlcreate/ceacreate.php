...
$NetHref = $dom->createElement('href', 'http://ossportal/out_dated/SLTIlastrator/images/ceanode.png');
...
$sql="SELECT  LAT,LOG,AREA,TYPE,VENDOR,PRODUCT  FROM OSSRPT.GPS_CORE_NW  where TYPE ='CEA NODE' and LAT is not null";
