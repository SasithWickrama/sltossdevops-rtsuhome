...
$NetHref = $dom->createElement('href', 'http://ossportal/out_dated/SLTIlastrator/images/mplscore.png');
...
$sql="SELECT  LAT,LOG,AREA,TYPE  FROM OSSRPT.GPS_CORE_NW  where TYPE ='MPLS_CORE'";
