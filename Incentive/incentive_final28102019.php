  ...
  <div class="row">
    ...
    <div class="col-md-12"> 
      ...
      <div class="card">
      	...
      	<div class="box-body">
      		<div class="page-title"><h4 style="font-family: 'ZCOOL XiaoWei', serif;">Incentive Application</h4></div>
      	</div>
      	</div>
      ...
      <div class="tab-content">
        ...
        <tbody>
            ...
            // $query="SELECT * FROM RTSU_INCENTIVE_FINAL ";
        ...
        <tbody>
            <?php 
             ...
             //$query="SELECT * FROM RTSU_SUP_DAILY ";
             $stid3=oci_parse($CON, $query);
             oci_execute($stid3);
            $cnt=1;
            while($row=oci_fetch_array($stid3))
        ...
        <tbody>
            <?php 
             $query="SELECT * FROM RTSU_TECH_FCR_DAILY WHERE OPMC = '".$opmc."'";
        ...
        <tbody>
            <?php 
             $query="SELECT * FROM RTSU_TECH_FR_DAILY WHERE OPMC = '".$opmc."'";
