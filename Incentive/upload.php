...
<link href="https://fonts.googleapis.com/css?family=DM+Serif+Text|ZCOOL+XiaoWei&display=swap" rel="stylesheet"> <script src='https://kit.fontawesome.com/a076d05399.js'></script>
  ...
  <div class="row">
    ...
    <div class="col-md-12"> 
      ...
      <div class="card">
          ...
          <lable style="color:#808b96;">Sign Out</lable>&nbsp;&nbsp;<a href="logout.php"><i class="fa fa-power-off" style="font-size:18px;  float: right; cursor: pointer;"></i></a>
          </div>
          </div>
