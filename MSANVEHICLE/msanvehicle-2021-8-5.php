...
<html>
  <head>
	...
	<!--<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDxb5RdPkgh2796wOx22ECeokZquR2A06g&..."></script>-->
...
from OSSPRG.GPS_LOCATION
where  LATITUDE is not null
and LONGITUDE is not null
and RTOM = '$rtom'";

$rebase = oci_parse($DBonn3, $sqlbase);
oci_execute($rebase);
...
var data6= [];
    ...
    xmlhttp.open("GET","msanvehicle2.php?id=msan",true);
    xmlhttp.send(); 	
}
