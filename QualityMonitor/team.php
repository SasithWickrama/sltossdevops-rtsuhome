...
// for(var i=0; i< parseInt(xmlhttp.responseText); i++ ){
    temp = temp+"<tr style=\"height: 15px;\"></tr>"+
        "<tr><td>"+
        "<lable name=\"team"+i+"\"><span style=\"font-size: medium; font-family: TimesNewRomen;\"><b>"+repx[1]+"</b></span></lable>"+
        "<input  name=\"team"+i+"\" id=\"team"+i+"\" value=\""+repx[1]+"\"  type=\"hidden\"/></td></tr>"+
        "<tr style=\"height: 5px;\"></tr>"+
        "<tr><td style=\"width: 180px;\">"+
        "<span style=\"font-size: medium; font-family: TimesNewRomen;\">Name</span> "+
        "</td><td style=\"width: 280px;\">"+
        "<input  name=\"name1"+i+"\" id=\"name1"+i+"\" class=\"form-control\"  type=\"text\" required>"+
        "</td><td style=\"width: 170px;\">"+
        "<span style=\"font-size: medium; font-family: TimesNewRomen;\">&nbsp;&nbsp;&nbsp;Name</span> "+
        "</td><td style=\"width: 285px;\">"+
        "<input  name=\"name2"+i+"\"id=\"name2"+i+"\" class=\"form-control\"  type=\"text\" required>"+
        "</td></tr>"+
        "<tr style=\"height: 5px;\"></tr>"+
        "<tr><td>"+
        "<span style=\"font-size: medium; font-family: TimesNewRomen;\">ID NO</span>"+
        "</td><td>"+
        " <input  name=\"idno1"+i+"\" id=\"idno1"+i+"\" class=\"form-control\"  type=\"text\" required>"+
        "</td><td>"+
        "<span style=\"font-size: medium; font-family: TimesNewRomen;\">&nbsp;&nbsp;&nbsp;ID NO</span>"+
        "</td><td>"+
        " <input  name=\"idno2"+i+"\" id=\"idno2"+i+"\" class=\"form-control\"  type=\"text\" required>"+
        "</td></tr>"+
        "<tr style=\"height: 5px;\"></tr>"+
        "<tr><td>"+
        "<span style=\"font-size: medium; font-family: TimesNewRomen;\">Contact NO</span> "+
        "</td><td>"+
        "<input  name=\"contact1"+i+"\" id=\"contact1"+i+"\" class=\"form-control\"  type=\"text\" required>"+
        "</td><td>"+
        "<span style=\"font-size: medium; font-family: TimesNewRomen;\">&nbsp;&nbsp;&nbsp;Contact NO</span> "+
        "</td><td>"+
        "<input  name=\"contact2"+i+"\" id=\"contact2"+i+"\" class=\"form-control\"  type=\"text\" required>"+
        "</td></tr>";
 ...
 document.getElementById('teamtbl').innerHTML = temp+"<tr style=\"height: 15px;\"></tr></table>";
    ...
    xmlhttp.open("GET","dynamic_load.php?q="+val+"&r="+opmc,true);
    xmlhttp.send();
}
...
//
  ...
  <body class="skin-blue">
    ...
    <form class="well form-horizontal" action="teamupdate.php" method="post"  id="contact_form">
    <fieldset>
    ...
    <!-- Form Name -->
        ...
        <td style="width: 250px;">
            <select name="region" id="region" class="form-control " onchange="getArea(this.value)">
