   ...
   $i=1;
	...
	<div class=\"row\">
                <div class=\"col-lg-12\">
                    ...
                    <h1 class=\"page-header\">Pending All Service Orders</h1>
					<h6>RTOM: $area </h6>
	...
	if ($id == 'twodays')
    {
      $con_retd = so_all_twodays($area,$sertyp,$ortyp);	
	...
	<div class=\"row\">
                <div class=\"col-lg-12\">
					...
					<h6>RTOM: $area </h6>
					<h6>SERVICE TYPE: $sertyp</h6>
					<h6>ORDER TYPE: $ortyp Less Than 3 Days</h6>
					<h5 align=\"right\"><a href=\"SLT_Manager_List2.php\">Back</a></h5>
                </div>
                <!-- /.col-lg-12 -->
            </div>";
    ...
    // No rows in the result set.
	    ...
	    if ($id == 'sixdays')
    {
      $con_retd = so_all_sixdays($area,$sertyp,$ortyp);	
	...
	<div class=\"row\">
                <div class=\"col-lg-12\">
					...
					<h6>RTOM: $area </h6>
					<h6>SERVICE TYPE: $sertyp</h6>
					<h6>ORDER TYPE: $ortyp Within 3 to 6 Days</h6>
					<h5 align=\"right\"><a href=\"SLT_Manager_List2.php\">Back</a></h5>
                </div>
                <!-- /.col-lg-12 -->
            </div>";
    ...
    // No rows in the result set.
	    ...
	    if ($id == 'moreseven')
    {
      $con_retd = so_all_moreseven($area,$sertyp,$ortyp);	
	...
	<div class=\"row\">
                <div class=\"col-lg-12\">
					...
					<h6>RTOM: $area </h6>
					<h6>SERVICE TYPE: $sertyp</h6>
					<h6>ORDER TYPE: $ortyp More Than 7 days</h6>
					<h5 align=\"right\"><a href=\"SLT_Manager_List2.php\">Back</a></h5>
                </div>
                <!-- /.col-lg-12 -->
            </div>";
