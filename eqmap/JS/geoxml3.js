...
/***custom code*********************/	
	var extrastring = "";
	if(iwText.includes("HH NO:") || iwText.includes("MH NO:")){
	  extrastring = "<img src=\"img/cable1.PNG\" alt=\"cable digram\" ></div>";
	}
	
	
//	if(iwText.includes("S-")  || iwText.includes("L-"))
...
/***custom code*********************/	
    ...
    var infoWindowOptions = geoXML3.combineOptions(parserOptions.infoWindowOptions, {
      content: '<div class="' + classTxt + '"' + styleProp + '>' + iwText + extrastring , 
    ...
    google.maps.event.addListener(gObj, 'click', function(e) {
	  ...
	  /* 012585 NEW ADDED*/
	  var tempcont = iW.getContent();
	  
		//if(userlevel == 2){
		console.log("inside");
		  //var tempcont1 = iW.getContent().replace(/<input/g, "<input disabled");
		 // tempcont = iW.getContent().replace(/id=/g, " disabled id=");
      ...
      iW.setContent("<div id='geoxml3_infowindow'>"+tempcont+"</div>");
