...
<html>
  <head>
   ...
   #over_map { position: absolute; top: 70px; right: 10px; z-index: 99; background-color:#FFF;padding:5px; border-radius:5px;font-family: Times New Roman, Times, serif; font-size:11px; width:18%}
...
<div id="over_map" class="box-body">
    ...
    <label for="staticEmail" class="col-sm-4 col-form-label">MAP TYPE</label>
    <div class="col-sm-8">
      <select class="form-control" id="maptype" name = "maptype"><option value="msan">MSAN WISE</option>
	 ...
	 <div class="form-group-sm">
		<input type="radio"  id="radios-0" value="poles">
	 ...
	 <div class="form-group-sm">
		<input type="radio"  id="radios-1" value="duct">
		<label>CPE ISSUE</label>
	 </div>
	 
	 <div class="form-group-sm">
	  <input type="radio"  id="radios-2" value="manholes">
	  <label>UG FACT</label>	
	 </div>
	 ...
	 <div class="form-group-sm">
	  ...
	  <div class="form-group-sm">
	  <input type="radio"  id="radios-3" value="manholes">
	  <label>PSTN</label>	
	 </div>
	 
	  <div class="form-group-sm">
	  <input type="radio"  id="radios-4" value="manholes">
	  <label>IPTV</label>	
	 </div>
	 
	  <div class="form-group-sm">
	  <input type="radio"  id="radios-5" value="manholes">
	  <label>FTTH</label>	
	 </div>
	 
	 <div class="form-group-sm">
	  <input type="radio"  id="radios-6" value="manholes">
	  <label>ADSL</label>	
	 </div>
	 
	 <div class="form-group-sm">
	  <input type="radio"  id="radios-7" value="manholes">
	  <label>DATA</label>	
	 </div>
