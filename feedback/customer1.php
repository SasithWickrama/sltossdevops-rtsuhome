...
xmlhttp.onreadystatechange=function() {
    ...
    document.getElementById('table1').style.display = '';
        ...
        var resp = xmlhttp.responseText.split("@");
          ...
          var tbl = "<table class=\"table table-bordered table-inverse\"> <tr bgcolor=\"#2E86C1\"><td>LEA</td><td>OPMC</td><td>FAULT ID</td><td>CIRCUIT ID</td><td>FEEDBACK</td><td>REPORTED TIME</td><td>CLOSED TIME</td><td>OUTAGE</td><td>CUSTOMER MOBILE</td><td>WORK GROUP</td><td>EMP NAME</td><td>EMP NUMBER</td><td>SMS DATE</td><td></td></tr>";
         
         for(var t =0; t<resp.length-1; t++){
          var temp = resp[t].split(",");
          
          tbl = tbl+"<tr><td>"+temp[12]+"</td><td>"+temp[0]+"</td><td>"+temp[1]+"</td><td>"+temp[10]+"</td><td>"+temp[2]+"</td><td>"+temp[3]+"</td><td>"+temp[4]+"</td><td>"+temp[5]+"</td><td>"+temp[6]+"</td><td>"+temp[7]+"</td><td>"+temp[8]+"</td><td>"+temp[9]+"</td><td>"+temp[13]+"</td>";
