...
,C.CIRT_DISPLAYNAME,STATUS,IN_DATE,LEA
...
while(oci_fetch($stid)){
 ...
 .",".oci_result($stid,oci_field_name($stid, 11)).",".oci_result($stid,oci_field_name($stid, 12)).",".oci_result($stid,oci_field_name($stid, 14))."@";	
}
