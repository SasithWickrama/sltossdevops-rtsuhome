...
<body>
	...
	<section class="top-category-widget-area section-gap">
		...
		<div class="container">
			<div class="row justify-content-between align-items-center text-center banner-content">
				<div class="col-lg-12">
					<h1 class="text-black" style="color: #bb8fce;">OTHER</h1>
					<p>RTSU</p>
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-lg-4">
					<div class="single-cat-widget">
						<div class="content relative" style="width: 300px;">
							...
							<a href="../QualityINS/login.html" target="_blank">
								<div class="thumb">
									<img class="content-image img-fluid d-block mx-auto" src="img/qulty.jpg" alt="" style="height: 150px;">
								</div>
								<div class="content-details">
									<h4 class="content-title mx-auto text-uppercase">Service Assurance Field <br>Team Quality Check</h4>
									<!-- <span></span> -->
				...
				<div class="col-lg-4">
					<div class="single-cat-widget">
						<div class="content relative" style="width: 300px;">
							...
							<a href="Faults/yfaults.html" target="_blank">
								<div class="thumb">
									<img class="content-image img-fluid d-block mx-auto" src="img/customer-service-girl.jpg" alt="" style="height: 150px;">
								</div>
								<div class="content-details">
									<h4 class="content-title mx-auto text-uppercase">Cleared Faults Callback<br>Verification</h4>
									<!-- <span></span> -->
				...
				<div class="col-lg-4">
					<div class="single-cat-widget">
						<div class="content relative" style="width: 300px;">
							<div class="overlay overlay-bg" style="opacity: 0.5;"></div>
							<a href="http://172.25.17.220/msanportcheck/listalluser.php" target="_blank">
								<div class="thumb">
									<img class="content-image img-fluid d-block mx-auto" src="img/ring.jpg" alt="" style="height: 150px;">
								</div>
								<div class="content-details">
									<h4 class="content-title mx-auto text-uppercase">MSAN Ring Tester</h4>
									<!-- <span></span> -->
			...
			<div class="row">
				<div class="col-lg-4">
					<div class="single-cat-widget">
						<div class="content relative" style="width: 300px;">
							<div class="overlay overlay-bg" style="opacity: 0.6;"></div>
							<a href="http://172.25.36.245/CQMS/login.aspx" target="_blank">
								<div class="thumb">
									<img class="content-image img-fluid d-block mx-auto" src="img/customer-care77.jpg" alt="" style="height: 150px;">
								</div>
								<div class="content-details">
									<h4 class="content-title mx-auto text-uppercase">CQMS</h4>
									<!-- <span></span> -->
									<!-- <p>Enjoy your social life together</p> -->
								</div>
							</a>
				...
				<div class="col-lg-4">
					<div class="single-cat-widget">
						<div class="content relative" style="width: 300px;">
							<div class="overlay overlay-bg" style="opacity: 0.6;"></div>
							<a href="http://172.25.17.225/RTSUHOME/QualityMonitor/login.html" target="_blank">
								<div class="thumb">
									<img class="content-image img-fluid d-block mx-auto" src="img/contractor3.jpg" alt="" style="height: 150px;">
								</div>
								<div class="content-details">
									<h4 class="content-title mx-auto text-uppercase">Service Assurance Contractor<br>Team Readiness</h4>
									<!-- <span></span> -->
									<!-- <p>Be a part of politics</p> -->
								</div>
							</a>
				...
				<div class="col-lg-4">
					<div class="single-cat-widget">
						<div class="content relative" style="width: 300px;">
							...
							<a href="http://172.25.36.252/SSD/Default.aspx" target="_blank">
								<div class="thumb">
									<img class="content-image img-fluid d-block mx-auto" src="img/mon2.jpg" alt="" style="height: 150px;">
								</div>
								<div class="content-details">
									<h4 class="content-title mx-auto text-uppercase">Project Monitoring</h4>
			...
			<div class="row">
				<div class="col-lg-4">
					<div class="single-cat-widget">
						<div class="content relative" style="width: 300px;">
							<div class="overlay overlay-bg" style="opacity: 0.5;"></div>
							<a href="ftthnewcon/ftthncon.html" target="_blank">
								<div class="thumb">
									<img class="content-image img-fluid d-block mx-auto" src="img/qc.jpg" alt="" style="height: 150px;">
								</div>
								<div class="content-details">
									<h4 class="content-title mx-auto text-uppercase">Quality Inspection for <br> FTTH New Connection</h4>
				...
				<div class="col-lg-4">
					<div class="single-cat-widget">
						<div class="content relative" style="width: 300px;">
							<div class="overlay overlay-bg" style="opacity: 0.5;"></div>
							<a href="Incentive/incentive_final.php" target="_blank">
								<div class="thumb">
									<img class="content-image img-fluid d-block mx-auto" src="img/recognition-schemes.jpg" alt="" style="height: 150px;">
								</div>
								<div class="content-details">
									<h4 class="content-title mx-auto text-uppercase">Incentive scheme</h4>
									<!-- <span></span> -->
									<!-- <p>Enjoy your social life together</p> -->
								</div>
							</a>
			...
			<div class="row">
				...
				<div class="col-lg-2 col-md-6 single-footer-widget">
					...
					<ul>
						...
						<li><a href="http://saturn/IntegratedBillingSystemInterface/login.aspx">IBSI</a></li>
