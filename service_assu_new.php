  ...
  <li class="nav-item">
	...
	<section class="top-category-widget-area section-gap">
		...
		<div class="container">
			<div class="row justify-content-between align-items-center text-center banner-content">
				<div class="col-lg-12">
					<h1 class="text-black" style="color:#bb8fce;">SERVICE ASSURANCE</h1>
					<p>RTSU</p>
				</div>
			</div>
		</div>
			...
			<div class="row">
					...
					<div class="single-cat-widget">
						<div class="content relative">
							...
							<a href="menu.php" target="_blank">
								<div class="thumb">
									<img class="content-image img-fluid d-block mx-auto" src="img/faultsummery.jpg" alt="" style="height:200px;">
								</div>
								<div class="content-details">
									<h4 class="content-title mx-auto text-uppercase">Pending Fault Summary</h4>
									<!-- <span></span> -->
				...
				<!-- <div class="col-lg-4">
					<div class="single-cat-widget" >
						<div class="content relative">
							...
							<!--<a href="feedback/customer1.php" target="_blank">-->
							<!-- <a href="web_uc/error.html" target="_blank">
								<div class="thumb">
									<img class="content-image img-fluid d-block mx-auto" src="img/satis2.jpg" alt="" style="height:200px;">
								</div>
								<div class="content-details">
									<h4 class="content-title mx-auto text-uppercase">Service Assurence Customer Satisfaction</h4> -->
									<!-- <span></span> -->
				...
				<div class="col-lg-4">
					<div class="single-cat-widget" >
						<div class="content relative">
							<div class="overlay overlay-bg" style="opacity: 0.55;"></div>
							<a href="http://172.25.37.251:8080/LTEFaultHandling/" target="_blank">
								<div class="thumb">
									<img class="content-image img-fluid d-block mx-auto" src="img/lte-fault2.jpg" alt="" style="height:200px;">
								</div>
								<div class="content-details">
									<h4 class="content-title mx-auto text-uppercase">LTE Fault Handling</h4>
									<!-- <span></span> -->
									<!-- <p>Be a part of politics</p> -->
								</div>
							</a>
