  ...
  <li class="nav-item">
	...
	<section class="top-category-widget-area section-gap">
		...
		<div class="container">
			<div class="row justify-content-between align-items-center text-center banner-content">
				<div class="col-lg-12">
					<h1 class="text-black" style="color: #bb8fce;">SERVICE FULFILMENT</h1>
					<p>RTSU</p>
				</div>
			</div>
		</div>
				...
				<div class="col-lg-4">
					<div class="single-cat-widget">
						<div class="content relative">
							...
							<a href="RTSU/index.php" target="_blank">
								<div class="thumb">
									<img class="content-image img-fluid d-block mx-auto" src="img/newcon.jpg" alt="" style="height: 210px;">
								</div>
								<div class="content-details">
									<h4 class="content-title mx-auto text-uppercase">Pending New Connection</h4>
									<!-- <span></span> -->
				...
				<div class="col-lg-4">
					<div class="single-cat-widget">
						<div class="content relative">
							...
							<!--<a href="NCfeedback/customer.html" target="_blank">-->
								<a href="web_uc/error.html" target="_blank">
								<div class="thumb">
									<img class="content-image img-fluid d-block mx-auto" src="img/satis2.jpg" alt="" style="height: 210px;">
								</div>
								<div class="content-details">
									<h4 class="content-title mx-auto text-uppercase">Service Fulfillment Customer Satisfaction</h4>
									<!-- <span></span> -->
				...
				<div class="col-lg-4">
					<div class="single-cat-widget">
						<div class="content relative">
							...
							<a href="https://serviceportal.slt.lk" target="_blank">
								<div class="thumb">
									<img class="content-image img-fluid d-block mx-auto" src="img/cmgt.jpg" alt="" style="height: 210px;">
								</div>
								<div class="content-details">
									<h4 class="content-title mx-auto text-uppercase">New Connection Contractor Management</h4>
									<!-- <span></span> -->
									<!-- <p>Enjoy your social life together</p> -->
								</div>
							</a>
			...
			<div class="row">
				...
				<!-- <div class="col-lg-4">
					<div class="single-cat-widget">
						<div class="content relative">
							<div class="overlay overlay-bg"></div>
							<a href="other.php" target="_self">
								<div class="thumb">
									<img class="content-image img-fluid d-block mx-auto" src="img/other.jpg" alt="" style="height: 210px;">
								</div>
								<div class="content-details">
