...
<body>
	...
	<section class="top-category-widget-area section-gap">
		...
		<div class="container">
			<div class="row justify-content-between align-items-center text-center banner-content">
				<div class="col-lg-12">
					<h1 class="text-black" style="color: #bb8fce;">SUPPORT</h1>
					<p>RTSU</p>
				</div>
			</div>
		</div>
			...
			<div class="row">
				...
				<div class="col-lg-4">
					<div class="single-cat-widget">
						<div class="content relative" style="width: 300px;">
							...
							<a href="http://insite.slt.com.lk/sites/CRO/Data%20Cleansing/Forms/AllItems.aspx?RootFolder=%2Fsites%2FCRO%2FData%20Cleansing%2FData%20upload&FolderCTID=0x012000145821F9AF517444BAF0769A0A0AA8A8&View=%7B1D20E390%2DA121%2D40D8%2DA1C7%2D0FD3E2632FC9%7D" target="_blank">
								<div class="thumb">
									<img class="content-image img-fluid d-block mx-auto" src="img/gis.jpg" alt="" style="height: 150px;">
								</div>
								<div class="content-details">
									<h4 class="content-title mx-auto text-uppercase">INCOMPLETE CCT AND GIS UPDATE</h4>
									<!-- <span></span> -->
				...
				<div class="col-lg-4">
					<div class="single-cat-widget">
						<div class="content relative" style="width: 300px;">
							<div class="overlay overlay-bg" style="opacity: 0.5;"></div>
							<a href="http://hq-dev-athena.intranet.slt.com.lk/#/workbooks/49/views" target="_blank">
								<div class="thumb">
									<img class="content-image img-fluid d-block mx-auto" src="img/meterbord.jpg" alt="" style="height: 150px;">
								</div>
								<div class="content-details">
									<h4 class="content-title mx-auto text-uppercase">SLT Meter Board</h4>
									<!-- <span></span> -->
				...
				<div class="col-lg-4">
					<div class="single-cat-widget">
						<div class="content relative" style="width: 300px;">
							<div class="overlay overlay-bg" style="opacity: 0.5;"></div>
							<a href="http://insite.slt.com.lk/sites/CC_Knowledge_Hub/EN/_layouts/15/start.aspx#/SitePages/Home.aspx" target="_blank">
								<div class="thumb">
									<img class="content-image img-fluid d-block mx-auto" src="img/knwl.jpg" alt="" style="height: 150px;">
								</div>
								<div class="content-details">
									<h4 class="content-title mx-auto text-uppercase">CC-Knowledge Hub</h4>
									<!-- <span></span> -->
			...
			<div class="row">
				<div class="col-lg-4">
					<div class="single-cat-widget">
						<div class="content relative" style="width: 300px;">
							<div class="overlay overlay-bg" style="opacity: 0.5;"></div>
							<a href="http://172.25.37.178/essp/Default.aspx" target="_blank">
								<div class="thumb">
									<img class="content-image img-fluid d-block mx-auto" src="img/sales.jpg" alt="" style="height: 150px;">
								</div>
								<div class="content-details">
									<h4 class="content-title mx-auto text-uppercase">Sales portal</h4>
									<!-- <span></span> -->
									<!-- <p>Enjoy your social life together</p> -->
								</div>
							</a>
				...
				<div class="col-lg-4">
					<div class="single-cat-widget">
						<div class="content relative" style="width: 300px;">
							...
							<a href="http://hq-jupiter/IntegratedBillingSystemInterface/login.aspx" target="_blank">
								<div class="thumb">
									<img class="content-image img-fluid d-block mx-auto" src="img/ibsi.jpg" alt="" style="height: 150px;">
								</div>
								<div class="content-details">
									<h4 class="content-title mx-auto text-uppercase">IBSI</h4>
									<!-- <span></span> -->
									<!-- <p>Be a part of politics</p> -->
								</div>
							</a>
				...
				<div class="col-lg-4">
					<div class="single-cat-widget">
						<div class="content relative" style="width: 300px;">
							<div class="overlay overlay-bg" style="opacity: 0.6;"></div>
							<a href="http://172.25.37.251:8080/PlannedOutage/" target="_blank">
								<div class="thumb">
									<img class="content-image img-fluid d-block mx-auto" src="img/power.jpg" alt="" style="height: 150px;">
								</div>
								<div class="content-details">
									<h4 class="content-title mx-auto text-uppercase">PLANNED POWER OUTAGE </h4>
									<!-- <span></span> -->
									<!-- <p>Let the food be finished</p> -->
								</div>
							</a>
