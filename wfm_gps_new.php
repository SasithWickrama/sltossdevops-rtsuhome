...
<body>
	...
	<section class="top-category-widget-area section-gap">
		...
		<div class="container">
			<div class="row justify-content-between align-items-center text-center banner-content">
				<div class="col-lg-12">
					<h1 class="text-black" style="color: #bb8fce;">GPS BASED APPLICATION</h1>
					<p>RTSU</p>
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-lg-4">
					<div class="single-cat-widget">
						<div class="content relative" style="width: 300px;">
							...
							<a href="MSANVEHICLE/msanvehicle.php" target="_blank">
								<div class="thumb">
									<img class="content-image img-fluid d-block mx-auto" src="img/msan (2).jpg" alt="" style="height: 150px;">
								</div>
								<div class="content-details">
									<h4 class="content-title mx-auto text-uppercase">MSAN Vehicle GPS</h4>
									<!-- <span></span> -->
				...
				<div class="col-lg-4">
					<div class="single-cat-widget">
						<div class="content relative" style="width: 300px;">
							...
							<!--<a href="MSANVEHICLE/caevehicle.php" target="_blank">-->
							<a href="MSANVEHICLE2/caevehicle.php" target="_blank">
								<div class="thumb">
									<img class="content-image img-fluid d-block mx-auto" src="img/vcl.jpg" alt="" style="height: 150px;">
								</div>
								<div class="content-details">
									<h4 class="content-title mx-auto text-uppercase">CEA Node Vehicle GPS</h4>
									<!-- <span></span> -->
				...
				<div class="col-lg-4">
					<div class="single-cat-widget">
						<div class="content relative" style="width: 300px;">
							<div class="overlay overlay-bg" style="opacity: 0.5;"></div>
							<a href="MSANVEHICLE2/ltevehicle.php" target="_blank">
							<!--<a href="MSANVEHICLE/ltevehicle.php" target="_blank">-->
								<div class="thumb">
									<img class="content-image img-fluid d-block mx-auto" src="img/our_profile.jpg" alt="" style="height: 150px;">
								</div>
								<div class="content-details">
									<h4 class="content-title mx-auto text-uppercase">LTE Basestation Vehicle GPS</h4>
									<!-- <span></span> -->
			...
			<div class="row">
				<div class="col-lg-4">
					<div class="single-cat-widget">
						<div class="content relative" style="width: 300px;">
							<div class="overlay overlay-bg" style="opacity: 0.5;"></div>
							<a href="DP4/fiberdp.php" target="_blank">
								<div class="thumb">
									<img class="content-image img-fluid d-block mx-auto" src="img/fiber.jpg" alt="" style="height: 150px;">
								</div>
								<div class="content-details">
									<h4 class="content-title mx-auto text-uppercase">Fiber DP Distribution</h4>
									<!-- <span></span> -->
									<!-- <p>Enjoy your social life together</p> -->
								</div>
							</a>
				...
				<div class="col-lg-4">
					<div class="single-cat-widget">
						<div class="content relative" style="width: 300px;">
							<div class="overlay overlay-bg" style="opacity: 0.6;"></div>
							<a href="DP3/copperdp.php" target="_blank">
								<div class="thumb">
									<img class="content-image img-fluid d-block mx-auto" src="img/copper.jpg" alt="" style="height: 150px;">
								</div>
								<div class="content-details">
									<h4 class="content-title mx-auto text-uppercase">Copper DP Distribution</h4>
									<!-- <span></span> -->
									<!-- <p>Be a part of politics</p> -->
								</div>
							</a>
				...
				<div class="col-lg-4">
					<div class="single-cat-widget">
						<div class="content relative" style="width: 300px;">
							<div class="overlay overlay-bg" style="opacity: 0.5;"></div>
							<a href="DP/faultdp.php" target="_blank">
								<div class="thumb">
									<img class="content-image img-fluid d-block mx-auto" src="img/fault_dp.jpg" alt="" style="height: 150px;">
								</div>
								<div class="content-details">
									<h4 class="content-title mx-auto text-uppercase">Fault DP Distribution</h4>
									<!-- <span></span> -->
									<!-- <p>Let the food be finished</p> -->
								</div>
							</a>
			...
			<div class="row">
				<div class="col-lg-4">
					<div class="single-cat-widget">
						<div class="content relative" style="width: 300px;">
							<div class="overlay overlay-bg" style="opacity: 0.5;"></div>
							<a href="eqmap/MSANMap.php" target="_blank">
								<div class="thumb">
									<img class="content-image img-fluid d-block mx-auto" src="img/faultanalyz.jpg" alt="" style="height: 150px;">
								</div>
								<div class="content-details">
									<h4 class="content-title mx-auto text-uppercase">MSAN & DP Wise Fault Analysis</h4>
									<!-- <span></span> -->
									<!-- <p>Enjoy your social life together</p> -->
								</div>
							</a>
				...
				<div class="col-lg-4">
					<div class="single-cat-widget">
						<div class="content relative" style="width: 300px;">
							<div class="overlay overlay-bg" style="opacity: 0.5;"></div>
							<a href="http://ossportal/SLTIlastrator/main.php" target="_blank">
								<div class="thumb">
									<img class="content-image img-fluid d-block mx-auto" src="img/ODF.jpg" alt="" style="height: 150px;">
								</div>
								<div class="content-details">
									<h4 class="content-title mx-auto text-uppercase">SLT Network Distribution</h4>
									<!-- <span></span> -->
									<!-- <p>Enjoy your social life together</p> -->
								</div>
							</a>
			...
			<div class="row">
				...
				<div class="col-lg-2 col-md-6 single-footer-widget">
					...
					<ul>
						...
						<li><a href="http://ossportal/SLTIlastrator/main.php">SLT Network Distribution</a></li>
					</ul>
				</div>
				<div class="col-lg-1 col-md-6 single-footer-widget">
