...
<body>
	...
	<section class="top-category-widget-area section-gap">
		...
		<div class="container">
			<div class="row justify-content-between align-items-center text-center banner-content">
				<div class="col-lg-12">
					<h1 class="text-black" style="color: #bb8fce;">WFM & MATERIAL UPDATE</h1>
					<p>RTSU</p>
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-lg-4">
					<div class="single-cat-widget">
						<div class="content relative">
							...
							<a href="http://172.25.37.227:8080/WFMADMIN" target="_blank">
								<div class="thumb">
									<img class="content-image img-fluid d-block mx-auto" src="img/dashboards.jpg" alt="" style="height: 210px;">
								</div>
								<div class="content-details">
									<h4 class="content-title mx-auto text-uppercase">WFM Dashboard</h4>
									<!-- <span></span> -->
				...
				<div class="col-lg-4">
					<div class="single-cat-widget">
						<div class="content relative">
							<div class="overlay overlay-bg" style="opacity: 0.6;"></div>
							<a href="http://hq-jupiter/CPETracker/Login.aspx?type=form" target="_blank">
								<div class="thumb">
									<img class="content-image img-fluid d-block mx-auto" src="img/trk.jpg" alt="" style="height: 210px;">
								</div>
								<div class="content-details">
									<h4 class="content-title mx-auto text-uppercase">CPE Tracking</h4>
									<!-- <span></span> -->
				...
				<div class="col-lg-4">
					<div class="single-cat-widget">
						<div class="content relative">
							<div class="overlay overlay-bg" style="opacity: 0.6;"></div>
							<a href="http://insite.slt.com.lk/sites/CBIO/isqm/MQFB/SitePages/MQFB%20Home.aspx" target="_blank">
								<div class="thumb">
									<img class="content-image img-fluid d-block mx-auto" src="img/Quality-Check.jpg" alt="" style="height: 210px;">
								</div>
								<div class="content-details">
									<h4 class="content-title mx-auto text-uppercase">Meterial Quality Check</h4>
									<!-- <span></span> -->
			...
			<div class="row">
				...
				<h4>RTSU-SYSTEM HUB</h4>
					<ul>
						...
						<!--<li><a href="http://172.25.37.171:8080/bbportal/Login">user port details with usage</a></li>-->
